...
#define	MSG_WIFI_JOIN_FAILD         1
#define	MSG_WIFI_CONNECTED          2
#define	MSG_WIFI_DISCONNECTED       3
#define	MSG_SOCKET_ERR              4
#define MSG_SOCKET_CREATE           5
#define MSG_START_SAMPLE            6
#define MSG_STOP_SAMPLE             7
#define	MSG_PARAM_CHANGED           8
...
#define SOCKET_CLIENT_TASK_PRIO             (USER_TASK_PRIO + 1)
#define SOCKET_CLIENT_TRAN_TASK_PRIO        (USER_TASK_PRIO + 2)
